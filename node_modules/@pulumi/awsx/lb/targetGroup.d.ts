...
import * as mod from ".";
import * as x from "..";
export declare abstract class TargetGroup extends pulumi.ComponentResource implements x.ecs.ContainerPortMappingProvider, x.ecs.ContainerLoadBalancerProvider, x.lb.ListenerDefaultAction, x.lb.ListenerActions {
