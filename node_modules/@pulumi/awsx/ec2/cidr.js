...
class Cidr32Block {
    ...
    constructor(startIpAddressInclusive, subnetMaskLeading1Bits) {
        this.startIpAddressInclusive = startIpAddressInclusive;
        this.subnetMaskLeading1Bits = subnetMaskLeading1Bits;
...
exports.Cidr32Block = Cidr32Block;
function getIPv4AddressValue(address) {
