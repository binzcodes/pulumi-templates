...
__exportStar(require("./applicationSnapshot"), exports);
// Import resources to register:
const application_1 = require("./application");
const applicationSnapshot_1 = require("./applicationSnapshot");
const _module = {
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws:kinesisanalyticsv2/applicationSnapshot:ApplicationSnapshot":
                return new applicationSnapshot_1.ApplicationSnapshot(name, undefined, { urn });
            default:
